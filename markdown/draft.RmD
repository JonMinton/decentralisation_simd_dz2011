...
Quantile   | RCI, 2004 | RCI, 2012  | Change  
---------- | --------  | ---------- | -------  
median     | 0.304     | 0.256      | -0.048
2.5% CrI   | 0.298     | 0.251      | -0.056
97.5% CrI  | 0.309     | 0.262      | -0.040


Quantile   | D, 2004 | D, 2012  | Change  
---------- | ------- | -------- | ------- 
median     | 0.414   | 0.377    | -0.037
2.5% CrI   | 0.409   | 0.372    | -0.044
97.5% CrI  | 0.418   | 0.382    | -0.030 
...
Quantile   | RCI, 2004 | RCI, 2012  | Change  
---------- | --------  | ---------- | -------  
median     | 0.218     | 0.187      | -0.031
2.5% CrI   | 0.213     | 0.181      | -0.040
97.5% CrI  | 0.224     | 0.193      | -0.022


Quantile   | D, 2004 | D, 2012  | Change  
---------- | ------- | -------- | ------- 
median     | 0.385   | 0.360    | -0.024
2.5% CrI   | 0.379   | 0.355    | -0.032
97.5% CrI  | 0.390   | 0.366    | -0.017 
...
Quantile   | RCI, 2004 | RCI, 2012  | Change  
---------- | --------  | ---------- | -------  
median     | 0.013     | -0.013     | -0.025
2.5% CrI   | 0.009     | -0.016     | -0.030
97.5% CrI  | 0.016     | -0.009     | -0.020


Quantile   | D, 2004 | D, 2012  | Change  
---------- | ------- | -------- | ------- 
median     | 0.385   | 0.319    | -0.067
2.5% CrI   | 0.382   | 0.316    | -0.071
97.5% CrI  | 0.389   | 0.322    | -0.062 



<!-- > round(apply(indicators_edinburgh, 2, quantile, c(0.5, 0.025, 0.975)),3) -->
<!--       RCI2004 RCI2012 D2004 D2012 -->
<!-- 50%     0.013  -0.013 0.385 0.319 -->
<!-- 2.5%    0.009  -0.016 0.382 0.316 -->
<!-- 97.5%   0.016  -0.009 0.389 0.322 -->
<!-- > ## Differences in RCI and D in 2011 - 2001 -->
<!-- > round(quantile(indicators_edinburgh[ ,2] - indicators_edinburgh[ ,1], c(0.5, 0.025, 0.975)),3) -->
<!--    50%   2.5%  97.5%  -->
<!-- -0.025 -0.030 -0.020  -->
<!-- > round(quantile(indicators_edinburgh[ ,4] - indicators_edinburgh[ ,3], c(0.5, 0.025, 0.975)),3) -->
<!--    50%   2.5%  97.5%  -->
<!-- -0.067 -0.071 -0.062  -->
<!-- >  -->
...
<!-- Joining by: "dz_2011" -->
<!-- data key contains NA's, which are ignored -->
<!-- Over coverage. 6628 out of 6975 unmatched data records: S01006789, S01006790, S01006791, S01006792, S01006793, ... -->
<!-- Setting up the model -->
<!-- Collecting 20000 samples -->
<!--   |====================================================================================| 100% -->
<!-- Summarising results -->
<!--  finished in  133.3 seconds -->
<!-- > round(apply(indicators_aberdeen, 2, quantile, c(0.5, 0.025, 0.975)),3) -->
<!--       RCI2004 RCI2012 D2004 D2012 -->
<!-- 50%     0.218   0.187 0.385 0.360 -->
<!-- 2.5%    0.213   0.181 0.379 0.355 -->
<!-- 97.5%   0.224   0.193 0.390 0.366 -->
<!-- > ## Differences in RCI and D in 2011 - 2001 -->
<!-- > round(quantile(indicators_aberdeen[ ,2] - indicators_aberdeen[ ,1], c(0.5, 0.025, 0.975)),3) -->
<!--    50%   2.5%  97.5%  -->
<!-- -0.031 -0.040 -0.022  -->
<!-- > round(quantile(indicators_aberdeen[ ,4] - indicators_aberdeen[ ,3], c(0.5, 0.025, 0.975)),3) -->
<!--    50%   2.5%  97.5%  -->
<!-- -0.024 -0.032 -0.017  -->
